export const customsTexts = {
	...
	"customs-16": {
		...
		en: "Additional vehicle per goods declaration",
		cn: "",
	},
	"customs-17": {
	...
	"customs-26": {
		ru: "Наша сильная сторона — это тщательный сбор информации о грузе и формирование необходимого пакета документов на этапе подготовки. В свою очередь, это позволяет производить таможенную очистку груза в кратчайшие сроки к вашей выгоде.",
		en: "Our strength is the thorough collection of information about the cargo and assembly of the required document package at the preparation stage. In turn, this allows customs clearance of cargo in the shortest possible time to your benefit.",
		cn: "",
	},
	"customs-27": {
	...
	"customs-35": {
		ru: "ООО «ТО.Л.К» подготовит пакет документов для подачи и получения классификационного решения ФТС РФ.",
		en: "TO.L.K will prepare a document package for submission and collection of the customs classification decision from the Federal Customs Service of the Russian Federation.",
		cn: "",
	},
	"customs-36": {
