export const transportationTexts = {
	...
	"transport-2": {
		ru: "ООО «ЕС Транс» выполняет перевозки комплектных и сборных грузов из Китая и по России авто, авиа и ж/д транспортом. Мы стремимся быть надежным партнером для всех, кто нуждается в перевозке грузов, обеспечивая безопасную, эффективную и своевременную доставку.",
		...
		cn: "ES Trans 物流有限公司提供从中国出发的空运和汽运服务，包含整车运输（FTL）和零担运输（LTL）。我们致力于成为每一位货运需求者值得信赖的合作伙伴，确保货物安全、高效、准时送达。",
	},
	"transport-3": {
		...
		cn: "我们与客户建立信任关系：在运输全程提供透明沟通，及时告知货物状态，预警潜在延误，并快速响应客户需求。所有车辆均配备GPS卫星追踪系统，可24小时实时精准定位货物位置。",
	},
	"transport-4": {
		...
		cn: "我们公司充分认识到货物准时送达对客户的重要性。为此，我们提供可靠的运输计划和最优路线，以保障货物及时准确抵达目的地。",
	},
	"transport-5": {
		...
		cn: "ES Trans 经验丰富的物流专家会周密规划每次运输，充分考虑货物特性、道路障碍及物流条件。我们的驾驶员均具备保障货物安全高效运输所需的丰富经验和专业知识。我们坚持高标准服务，郑重保证货物准时完好送达。",
	},
	"transport-6": {
		...
		cn: "我们工作的首要任务是确保货运服务的高标准可靠性与安全性。ES Trans 有限公司拥有配备先进技术和安全系统的新型货运车队。所有车辆均定期接受维护检修，保障行车安全。公司驾驶员均经过严格的道路安全规程培训。",
	},
	"transport-7": {
		ru: "Наша ответственность застрахована на сумму 25 000 000 руб.",
		en: "Our liability is insured for RUB 25,000,000.",
		cn: "我们的责任险保额为 25 000 000 卢布。",
	},
	"transport-8": {
	...
	"transport-9": {
		ru: "Мы перевозим грузы из Китая и по России, как собственным транспортом, так и с помощью наших партнеров по автоперевозкам (привлеченный парк около 500 автомобилей). У нас налажены долгосрочные партнерские отношения с проверенными и надежными автоперевозчиками, чтобы обеспечить качественную и своевременную доставку грузов нашим клиентам.",
		...
		cn: "ES Trans 物流有限公司既使用自有车队，又通过汽车运输合作伙伴（协作车队约500辆）提供从中国货运服务。我们与优质可靠的承运商建立长期合作关系，确保为客户提供高效准时的物流服务。",
	},
	"transport-10": {
		...
		cn: "我们的物流操作员会说中文，并与中国运输合作伙伴紧密协作，安排从装货点提货、办理必要海关手续，直至将货物送达目的地。",
	},
	"transport-11": {
	...
	"transport-12": {
		...
		cn: "选择 ES Trans，您将获得中俄跨境货运领域的高效可靠伙伴。快捷的运输、极具竞争力的运费和全程货物护航——这正是您成功的保障！",
	},
	"transport-13": {
		...
		cn: "快速获取汽运报价与时效预估，点击下方红色按钮填写表格，实时测算。",
	},
	"transport-14": {
		ru: "Авиаперевозки",
		en: "Air carriage",
	...
	"transport-15": {
		...
		cn: "我们提供优惠的空运解决方案，确保从中国发出的货物快速安全送达。",
	},
	"transport-16": {
		...
		cn: "在航空货运中，速度与可靠性是核心要素。为此，我们为客户提供高标准服务：严守时效并确保货物完好无损。",
	},
	"transport-17": {
		...
		cn: "我们与多家航空公司和代理合作，这使我们能够选择最优路线和灵活的运输方案。我们安排从始发地提货，提供规范的包装和报关清关服务，随后通过空运将货物运送至目的地。",
	},
	"transport-18": {
		...
		cn: "为了快速初步评估空运费用和运输时间，请点击下方区块中的红色按钮，填写简短表格。",
	},
